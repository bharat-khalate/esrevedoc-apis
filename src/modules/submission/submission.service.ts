 ...
 */
export default function (submissionRepository: TSubmissionRepository) {
  return {
    /**
     ...
     */
    create: async (reqBody: ICreateServiceParam, userId: number) => {
      const submission: TCreateSubmissionPayload = {
     ...
     * @throws Rethrows repository or database errors.
     */
    getAll: async (query: IGetAllServiceParam, userId: number) => {
     ...
     * @throws Rethrows repository or database errors.
     */
    getDetails: async (submissionId: number, userId: number) => {
